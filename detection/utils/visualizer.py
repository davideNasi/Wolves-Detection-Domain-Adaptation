...
class Visualizer:
    ...
    def draw_instance_predictions(self, predictions):
        ...
        labels = _create_text_labels(classes, scores, self.metadata.get("label2name", None))
        ...
        if self._instance_mode == ColorMode.IMAGE_BW:
            assert 'masks' in predictions, "ColorMode.IMAGE_BW requires segmentations"
    ...
    def draw_dataset_dict(self, dic):
        ...
        Args:
            dic (dict): annotation/segmentation data7 of one image, in Detectron2 Dataset format.
